 ...
 */
@Autonomous(name = "Autonomous_Blue_Warehouse", group = "00-Autonomous" , preselectTeleOp = "SSTeleOp")
public class Autonomous_Blue_Warehouse extends LinearOpMode {
    ...
    public Pose2d startPose = BLUE_WAREHOUSE_STARTPOS;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // 1.	Robot starts position with bucket in transport state in Level 1 with pre-loaded box in it.
        startPose = BLUE_WAREHOUSE_STARTPOS;
    ...
    /**
    */
    public void runAutoBlueWarehouse(){
        //Logic for waiting
        safeWait(100);
