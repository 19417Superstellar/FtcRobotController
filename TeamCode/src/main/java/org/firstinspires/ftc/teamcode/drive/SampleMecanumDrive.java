...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients TRANSLATIONAL_PID = SmartdampPID.TranslationCoefficientsSMART(4);//1
    public static PIDCoefficients HEADING_PID = SmartdampPID.RotationCoefficientsSMART(4);//0.5
