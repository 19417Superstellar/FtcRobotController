...
/**
 * Path and actions for autonomous mode starting from from Red Storage position
...
@Autonomous(name = "Autonomous_Red_Storage", group = "00-Autonomous" , preselectTeleOp = "SSTeleOp")
public class Autonomous_Red_Storage extends LinearOpMode {
    ...
    public Pose2d startPose = RED_STORAGE_STARTPOS;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // 1.	Robot starts position with bucket in transport state in Level 1 with pre-loaded box in it.
        startPose = RED_STORAGE_STARTPOS;
    ...
    public void runAutoRedStorage(){
        ...
        switch (targetZone) {
            case LEVEL1:
                ...
                traj = driveTrain.trajectoryBuilder(driveTrain.getPoseEstimate())
                        .lineToLinearHeading(new Pose2d(48,-39.5, Math.toRadians(0)))
                        .build();
                break;
            case LEVEL2:
                traj = driveTrain.trajectoryBuilder(driveTrain.getPoseEstimate())
