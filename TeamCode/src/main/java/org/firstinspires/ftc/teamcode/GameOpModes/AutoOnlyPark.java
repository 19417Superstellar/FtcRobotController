 ...
 */
@Autonomous(name = "FTC Wires Auto Only Park", group = "00-Autonomous", preselectTeleOp = "SSTeleOp")
        ...
        switch (startPosition) {
            case BLUE_LEFT:
                ...
                switch(vision.identifiedparkingLocation){
                    case 1: parkPose = new Pose2d(-8, 60, Math.toRadians(85)); break; // Location 1
                    case 2: parkPose = new Pose2d(-9, 36, Math.toRadians(-90)); break; // Location 2
                    case 3: parkPose = new Pose2d(-8, 11, Math.toRadians(-90)); break; // Location 3
                }
                break;
            case BLUE_RIGHT:
                initPose = new Pose2d(-54, -36, Math.toRadians(0));//Starting pose
                midWayPose = new Pose2d(-8, -36, Math.toRadians(0)); //Choose the pose to move forward towards signal cone
                switch(vision.identifiedparkingLocation){
                    case 1: parkPose = new Pose2d(-8, -11, Math.toRadians(85)); break; // Location 1
                    case 2: parkPose = new Pose2d(-9, -36, Math.toRadians(-90)); break; // Location 2
                    case 3: parkPose = new Pose2d(-8, -60, Math.toRadians(-90)); break; // Location 3
                }
                break;
            case RED_LEFT:
                initPose = new Pose2d(54, -36, Math.toRadians(180));//Starting pose
                midWayPose = new Pose2d(8, -36, Math.toRadians(180)); //Choose the pose to move forward towards signal cone
                switch(vision.identifiedparkingLocation){
                    case 1: parkPose = new Pose2d(8, -60, Math.toRadians(270)); break; // Location 1
                    case 2: parkPose = new Pose2d(9, -36, Math.toRadians(90)); break; // Location 2
                    case 3: parkPose = new Pose2d(8, -11, Math.toRadians(90)); break; // Location 3
                }
                break;
            case RED_RIGHT:
                ...
                midWayPose = new Pose2d(8, 36, Math.toRadians(180)); //Choose the pose to move forward towards signal cone
                switch(vision.identifiedparkingLocation){
                    case 1: parkPose = new Pose2d(8, 11, Math.toRadians(270)); break; // Location 1
                    case 2: parkPose = new Pose2d(9, 36, Math.toRadians(90)); break; // Location 2
                    case 3: parkPose = new Pose2d(8, 60, Math.toRadians(90)); break; // Location 3
                }
                break;
