...
public class Autonomous_BR_Forward {
         ...
         */
        @Autonomous(name = "Autonomous_BR_Forward", group = "00-Autonomous", preselectTeleOp = "SSTeleOp")
        public class Autonomous_Red_Warehouse extends LinearOpMode {
            ...
            public org.firstinspires.ftc.teamcode.Subsystems.SSElevator SSElevator;
            public org.firstinspires.ftc.teamcode.Subsystems.SSArm SSArm;
            ...
            public void runOpMode() throws InterruptedException {
                ...
                traj = driveTrain.trajectoryBuilder(driveTrain.getPoseEstimate())
                        .lineToLinearHeading(new Pose2d(-12, -30, Math.toRadians(45)))
                        .build();
                ...
                //6
                traj = driveTrain.trajectoryBuilder(driveTrain.getPoseEstimate())
                        .lineToLinearHeading(new Pose2d(-14, -56, Math.toRadians(270)))
                        .build();
