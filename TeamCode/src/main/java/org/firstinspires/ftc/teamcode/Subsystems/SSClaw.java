...
public class SSClaw {
    ...
    public static double GRIP_OPEN_POSITION_LEFT = 0.2;
    public static double GRIP_CLOSE_POSITION_LEFT = 0.33;

    public static double GRIP_OPEN_POSITION_RIGHT = 0.85;
    public static double GRIP_CLOSE_POSITION_RIGHT = 0.76;
