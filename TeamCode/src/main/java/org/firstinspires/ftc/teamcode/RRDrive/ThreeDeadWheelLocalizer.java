...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  -11836.554306504508; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 12112.636122225931; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -8873.690936827927; // x position of the perpendicular encoder (in tick units)
    }
